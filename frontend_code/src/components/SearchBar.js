...
function SearchBar(props) {
    ...
    const changeSearchType = (e) => {
        ...
        setError("");
        if (searchType === SEARCH_KEY.all || searchType === SEARCH_KEY.map) {
    ...
    return (
        <div className="search-bar">
            <Search
                ...
                disabled={searchType === SEARCH_KEY.all || searchType === SEARCH_KEY.map}
            />
            ...
            >
                ...
                <Radio value={SEARCH_KEY.map}>Around</Radio>
            </Radio.Group>
        </div>
    );
}
